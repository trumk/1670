...
namespace buoi4_all.Controllers
{
    public class ProductsAdminController : Controller
    {
        private readonly buoi4_allContext _context;

        public ProductsAdminController(buoi4_allContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Product != null ? 
                          ...
                          Problem("Entity set 'buoi4_allContext.Product'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'buoi4_allContext.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
